...
namespace AzureIoTHubConnectedService
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandCloudToDeviceMsg
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandCloudToDeviceMsg(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static CommandCloudToDeviceMsg Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new CommandCloudToDeviceMsg(package);
        }

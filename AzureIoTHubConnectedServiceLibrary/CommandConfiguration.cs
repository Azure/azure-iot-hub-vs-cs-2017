...
namespace AzureIoTHubConnectedService
{
    ...
    internal sealed class CommandConfiguration
    {
        ...
        private CommandConfiguration(Package package)
        {
            if (package == null)
            {
        ...
        {
            Instance = new CommandConfiguration(package);
        }
        ...
        {
            Microsoft.VisualStudio.Telemetry.TelemetryService.DefaultSession.PostEvent("vs/iothubcs/ExtraDisplayConfiguration");

...
namespace AzureIoTHubConnectedService
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandDeviceTwin
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandDeviceTwin(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static CommandDeviceTwin Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new CommandDeviceTwin(package);
        }
        ...
        {
            Microsoft.VisualStudio.Telemetry.TelemetryService.DefaultSession.PostEvent("vs/iothubcs/ExtraDisplayDeviceTwin");

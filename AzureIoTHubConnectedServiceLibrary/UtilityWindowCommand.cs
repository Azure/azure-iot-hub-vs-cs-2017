...
namespace AzureIoTHubConnectedService
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class UtilityWindowCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private UtilityWindowCommand(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static UtilityWindowCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new UtilityWindowCommand(package);
        }
        ...
        private void MenuItemCallback(object sender, EventArgs ea)
        {
            ...
            DisplayWindow(typeof(UtilityWindowDevices));
            DisplayWindow(typeof(UtilityWindowHubs));
            DisplayWindow(typeof(UtilityWindowCloudToDeviceMsg));
            DisplayWindow(typeof(UtilityWindowReceiveMsgs));
            DisplayWindow(typeof(UtilityWindowDeviceTwin));
        ...
        private void DisplayWindow(Type type)
        {
            ...
            //windowFrame.SetProperty((int)__VSFPROPID.VSFPROPID_IsWindowTabbed, __VSTABBEDMODE.VSTABBEDMODE_Tabbed);

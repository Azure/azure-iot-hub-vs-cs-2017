...
namespace AzureIoTHubConnectedService
{
    ...
    /// Command handler
    /// </summary>
    internal sealed class CommandDeviceToCloudMsgs
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        private CommandDeviceToCloudMsgs(Package package)
        {
            if (package == null)
            {
        ...
        /// </summary>
        public static CommandDeviceToCloudMsgs Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new CommandDeviceToCloudMsgs(package);
        }
        ...
        {
            Microsoft.VisualStudio.Telemetry.TelemetryService.DefaultSession.PostEvent("vs/iothubcs/ExtraDisplayMonitorD2C");
